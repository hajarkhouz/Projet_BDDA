...
public class DBConfig {
    private String dbpath;// chemin de la base de données
    private int pageSize;// taille de la page
    private int dmMaxFileCount;// nombre maximum de fichiers
    private long dmMaxFileSize;// taille maximum d'un fichier

    private int bmBufferCount; // nombre de buffers dans le buffer manager
    private String bmPolicy; // politique de remplacement des pages
    ...
    public static DBConfig LoadDBConfig(String fichier_config) {// méthode statique pour charger la config depuis un fichier
        String dbpath = null;
        int pageSize = 0;
